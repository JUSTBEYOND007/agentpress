...
export const DEFAULT_EVAL_METRICS: readonly EvalMetricDefinition[] = [
  ...
  metric('claimsWithoutEvidence', 'Claims without Evidence', 'result', 'number', false, 'sum'),
  metric('unknownRetention', 'Unknown retention', 'result', 'percent', true, 'mean'),
  metric('conflictRecall', 'Conflict recall', 'result', 'percent', true, 'mean'),
  metric(
