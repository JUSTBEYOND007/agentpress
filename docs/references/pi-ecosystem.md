...
| ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Client/session/transport                 | `packages/mcp-runtime/src/client-gateway.ts`, `streamable-http.ts`, `server-manager.ts`                                                                                                    | Official SDK `1.30.0` owns MCP client/session and JSON-RPC transport types. Connection state, retry circuit, cancellation and `outcome_unknown` mapping stay in `mcp-runtime`; no SDK type crosses Domain.                                                                                                                                                             | `packages/mcp-runtime/test/client-gateway.test.ts`, `server-manager.test.ts`, `streamable-http.integration.test.ts`                                                         |
...
| RunEvent and consumer projection         | `packages/agent-application/src/run-projection.ts`, `run-projection-service.ts`; Web `apps/web/src/lib/agent-execution-projection.ts` and `agent-tool-audit-projection.ts`                 | Product projection exposes goal/result/outcome and redacted diagnostics. Server/tool/revision/transport and raw guarded payload remain audit-only; live and replay use the same facts.                                                                                                                                                                                 | `packages/agent-application/test/run-projection.test.ts`, `apps/web/src/lib/agent-runtime-projection.test.ts`, `agent-tool-audit-projection.test.ts`                        |
